    ...
    <v-card>
      <v-list class="menu">
        ...
        <v-list-item>
          ...
          <v-list-item-content>
            <v-list-item-title>更新选项</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item>
          <v-list-item-action />
          <v-list-item-content>
            <v-list-item-title>更新SMM地址：</v-list-item-title>
          </v-list-item-content>
          <v-list-item-action>
            <v-select
        ...
        <v-list-item>
          <v-list-item-action />
          <v-list-item-content>
            <v-list-item-title>显示被忽略的更新</v-list-item-title>
          </v-list-item-content>
          <v-list-item-action>
            <v-switch
        ...
        >
          <v-list-item-action />
          <v-list-item-content>
            <v-list-item-title>SMM更新 ({{ smmUpdateCount }})</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-list-item>
          <v-list-item-action />
          <v-list-item-content>
            <v-list-item-title>更新可能会丢失汉化</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-divider
          inset
